...
\begin{tabular}{|l|c|cc|}
				\hline
				& Chiffrement des données & \multicolumn{2}{l|}{Dérivation des clés}                                                                                                                         \\ \hline
				LastPass  & AES-CBC 256             & \multicolumn{1}{c|}{Argon2d} & \begin{tabular}[c]{@{}l@{}}PBKDF2-SHA2\\ 100'100 rounds\end{tabular}  \\ \hline
				Dashlane  & AES-256                 & \multicolumn{1}{c|}{Argon2d} & \begin{tabular}[c]{@{}l@{}}PBKDF2-SHA2\\ 200'000 rounds\end{tabular}  \\ \hline
				1Password & AES-GCM 256             & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}l@{}}PBKDF2-SHA2\\ 100'000 rounds\end{tabular}}        \\ \hline
				KeePass   & AES-CBC 256 ou ChaCha20 & \multicolumn{1}{c|}{AES-KDF} & Argon2                                                                \\ \hline
				Bitwarden & AES-CBC 256             & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}l@{}}PBKDF2-SHA2\\ 100'000 rounds\end{tabular}}          \\ \hline
				NordPass  & XChaCha20-Poly1305-IETF               & \multicolumn{2}{c|}{Argon2id}                                                                        \\ \hline
				Padloc    & AES-GCM 256             & \multicolumn{2}{c|}{PBKDF2-SHA2}                                                                   \\ \hline
				Keeper    & AES-256                 & \multicolumn{2}{c|}{PBKDF2}                                                  \\ \hline
				Firefox   & AES-CBC ou 3DES-CBC                & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}l@{}}PBKDF2-SHA2 et HKDF\\ 1000 rounds\end{tabular}}                                                                  \\ \hline
			\end{tabular}
	\caption{Algorithmes cryptographiques utilisés dans les gestionnaires\label{crypto}}
\end{table}
